...
@admin.register(UE)
class UEAdmin(SimpleHistoryAdmin):
...
@admin.register(EC)
class ECAdmin(SimpleHistoryAdmin):
...
class EtudiantAdmin(SimpleHistoryAdmin):
...
class NoteECAdmin(SimpleHistoryAdmin):
...
class ResultatUEAdmin(SimpleHistoryAdmin):
